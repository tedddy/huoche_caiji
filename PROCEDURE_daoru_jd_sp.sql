...
SET jd_sx_yanse_hc = IF(jd_sx_yanse_hc = '' OR jd_sx_yanse_hc LIKE '%db:%', NULL, jd_sx_yanse_hc);
SET jd_yuanjia_hc = IF(jd_yuanjia_hc = '' OR jd_yuanjia_hc LIKE '%db:%', NULL, CAST(jd_yuanjia_hc AS DECIMAL));
SET jd_xianjia_hc = IF(jd_xianjia_hc = '' OR jd_xianjia_hc LIKE '%db:%', NULL, CAST(jd_xianjia_hc AS DECIMAL));
SET jd_zuidijia_hc = IF(jd_zuidijia_hc = '' OR jd_zuidijia_hc LIKE '%db:%', NULL, CAST(jd_zuidijia_hc AS DECIMAL));
SET jd_zdj_riqi_hc = IF(jd_zdj_riqi_hc = '' OR jd_zdj_riqi_hc LIKE '%db:%', NULL, CAST(jd_zdj_riqi_hc AS DATE));
...
SET jd_zoushitu_hc = IF(jd_zoushitu_hc = '' OR jd_zoushitu_hc LIKE '%db:%', NULL, jd_zoushitu_hc);
...
ON DUPLICATE KEY UPDATE 
	...
	`jd_yuanjia` = IF(jd_yuanjia_hc IS NULL, `jd_yuanjia`, jd_yuanjia_hc),
	`jd_xianjia` = IF(jd_xianjia_hc IS NULL, `jd_xianjia`, jd_xianjia_hc),
	...
	`jd_tupian_yidong` = IF(jd_tupian_yidong_hc IS NULL, `jd_tupian_yidong`, jd_tupian_yidong_hc),
	...
	`jd_zoushitu` = IF(jd_zoushitu_hc IS NULL, `jd_zoushitu`, jd_zoushitu_hc),
